<?php 
    ...
    require '../app/controllers/admin/user/vendor/autoload.php';
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="dashboard.php">
                ...
                <div class="sidebar-brand-text mx-2">Resort Employee<sup></sup></div>
            </a>
...
<!--             <li class="nav-item ">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h4 class="h4 mb-0 text-gray-800">Users & Revenue</h4>
                    <!-- Content Row -->
                    <div class="row">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php
                                                $totalexpenses=0;
                                                $sql = "SELECT SUM(Total_paid) FROM reservation WHERE checkout=Year(curdate()) AND approvalstatus='Checkout'";
                                                $result = $con->query($sql);
                                                while($row = mysqli_fetch_array($result)){
                                                    echo "Php ". $row['SUM(Total_paid)'];
                                                }
                                                ?>
                                               </div>
                                        </div>
                    ...
                    <div class="row">
                     ...
                     <h4 class="h4 mb-0 text-gray-800">Accomudation & Services</h4>
                    <div class="row">
                        <!-- Earnings (Monthly) Card Example -->
                        <div class="col-xl-4 col-md-6 mb-4">
                            <div class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php $sql="select * from services";
                                                $result=mysqli_query($con,$sql); 
                                                    $rws=mysqli_num_rows($result);
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                                Rooms</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php $sql="select * from rooms";
                                                $result=mysqli_query($con,$sql); 
                                                    $rws=mysqli_num_rows($result);
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Cottages</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php $sql="select * from cottages";
                                                $result=mysqli_query($con,$sql); 
                                                    $rws=mysqli_num_rows($result);
                    ...
                    <h4 class="h4 mb-0 text-gray-800">Reservations</h4>
                    <div class="row">
                        <!-- Earnings (Monthly) Card Example -->
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-warning shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Total Reservations
                                            </div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php $sql="select * from reservation";
                                                $result=mysqli_query($con,$sql); 
                                                    $rws=mysqli_num_rows($result);
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php $sql="select * from reservation where approvalstatus='Approved'";
                                                $result=mysqli_query($con,$sql); 
                                                    $rws=mysqli_num_rows($result);
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">
                                                Rejected</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php $sql="select * from reservation where approvalstatus='Rejected'";
                                                $result=mysqli_query($con,$sql); 
                                                    $rws=mysqli_num_rows($result);
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php $sql="select * from reservation where approvalstatus='Pending'";
                                                $result=mysqli_query($con,$sql); 
                                                    $rws=mysqli_num_rows($result);
    ...
    <!-- Page level plugins -->
    <script src="boost/vendor/chart.js/Chart.min.js"></script>
