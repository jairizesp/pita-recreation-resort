...
if($kids==''){
 ...
 if($days>1){
    ...
    $sql_insert="INSERT INTO reservation set name_guest='$name',checkin='$from_date',checkout='$to_date',adult='$adult',children='$kids',approvalstatus='Approved', restype='Walkin', approve_by='Admin'";
 	...
 	$sql_insert="INSERT INTO reservation set name_guest='$name',checkin='$from_date',checkout='$to_date',adult='$adult',children='$kids',approvalstatus='Approved',balance='$total_payment', restype='Walkin', approve_by='Admin'";
           if ($con->query($sql_insert) === TRUE) {
...
$idd =$_POST['res_id'];
	$update_balance="UPDATE reservation set approvalstatus='Checkout',balance='0',Total_paid='$remaining',status='$mop', approve_by='Admin' where id ='$idd'";
